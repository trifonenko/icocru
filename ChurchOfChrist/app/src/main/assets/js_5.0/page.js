...
var a2a = a2a || {
	...
	button: function(a) {
		var b = a.node,
			...
			e = a2a.has_menter;
		b.getAttribute("onclick") && (b.getAttribute("onclick") + "").indexOf("a2a_") != -1 || b.getAttribute("onmouseover") && (b.getAttribute("onmouseover") + "").indexOf("a2a_") != -1 || (a2a.add_event(b, "click", function(a) {
		...
		}), !a2a[a2a.type].onclick && e && (a2a.c.delay ? b.onmouseenter = function() {
	...
	kit: function(a, b) {
		...
		C && !isNaN(C) && (a2a.svg.load(), x && "unset" != x && a2a.svg.works() && (z && "unset" != z && (F.backgroundColor = z), A && "unset" != A.trim() && (A = A.trim())), m.style.lineHeight = G.height = G.lineHeight = D, G.width = 2 * C + "px", G.fontSize = "16px", I && (G.height = G.lineHeight = C / 2 + "px", G.fontSize = "10px", G.width = C + "px"), 32 != C && (F.backgroundSize = F.height = F.lineHeight = F.width = D, G.borderRadius = F.borderRadius = (.14 * C).toFixed() + "px", G.fontSize = (parseInt(G.height, 10) + (I ? 4 : 0)) / 2 + "px")), a2a.kit.facebook_like = function() {
			fa.href = t, fa.width = "90", fa.layout = "button_count", fa.ref = "addtoany", fa = i(O, fa), O.style.width = fa.width + "px";
			var a = "v2.9",
				b = function() {
					FB.init({
						appId: "0",
				...
				c = a2a.i18n();
			c = c ? c.replace(/-/g, "_") : "en_US", 2 == c.length && (c += "_" + c.toUpperCase());
			for (var d in fa) ea += " data-" + d + '="' + fa[d] + '"';
			window.fbAsyncInit || (window.fbAsyncInit = b, K = document.createElement("span"), K.id = "fb-root", document.body.insertBefore(K, document.body.firstChild)), a2a.kit.facebook_like_script || ! function(b, d, e) {
				var f, g = b.getElementsByTagName(d)[0];
				b.getElementById(e) || (f = b.createElement(d), f.id = e, f.src = "//connect.facebook.net/" + c + "/sdk.js#xfbml=1&version=" + a, g.parentNode.insertBefore(f, g))
			}(document, "script", "facebook-jssdk"), a2a.kit.facebook_like_script = 1, O.innerHTML = '<div class="fb-like"' + ea + "></div>";
			try {
				FB.XFBML.parse(O)
			} catch (e) {}
		}, a2a.kit.twitter_tweet = function() {
			fa.url = t, fa.lang = a2a.i18n() || "en", fa.related = "AddToAny,micropat";
			var a = l.twitter,
				b = a ? a.lastIndexOf("@") : null;
			b && b !== -1 && (b++, b = a.substr(b).split(" ", 1), b = b[0].replace(/:/g, "").replace(/\//g, "").replace(/-/g, "").replace(/\./g, "").replace(/,/g, "").replace(/;/g, "").replace(/!/g, ""), fa.related = b + ",AddToAny"), fa = i(O, fa);
			var c = document.createElement("a");
			c.className = "twitter-share-button";
			for (var d in fa) c.setAttribute("data-" + d, fa[d]);
			...
			fa["pin-config"] = "beside", fa["pin-do"] = "buttonPin", fa.media = w, fa.url = t, fa = i(O, fa);
			var a = document.createElement("a");
			for (var b in fa) a.setAttribute("data-" + b, fa[b]);
			"beside" == fa["pin-config"] && "buttonPin" == fa["pin-do"] && (O.style.width = "76px"), a.href = "//www.pinterest.com/pin/create/button/?url=" + fa.url + (fa.media ? "&media=" + fa.media : "") + (fa.description ? "&description=" + encodeURIComponent(fa.description).replace(/'/g, "%27") : ""), a2a.add_event(O, "click", function() {
			...
			fa.counter = "right", fa.onsuccess = "a2a.kit.linkedin_share_event", fa.url = t, fa = i(O, fa);
			for (var a in fa) ea += " data-" + a + '="' + fa[a] + '"';
			...
			}(document), a2a.kit.linkedin_share_script = 1, O.innerHTML = '<script type="IN/Share"' + ea + "></script>"
			...
			}, fa.href = t, fa.size = "medium", fa.annotation = "bubble", "google_plus_share" == T && (fa.action = "share"), fa = i(O, fa);
			var a = a2a.i18n() || "en-US";
			window.___gcfg = window.___gcfg || {
				lang: a
			};
			for (var b in fa) ea += " data-" + b + '="' + fa[b] + '"';
			O.innerHTML = '<div class="g-plus' + ("share" == fa.action ? "" : "one") + '" data-callback="google_plus_cb_a2a"' + ea + "></div>", a2a.kit.google_plus_script || (! function(a) {
				var b = a.createElement("script"),
					c = a.getElementsByTagName("script")[0];
		...
		for (var J = 0; J < q; J++) {
			var K, L, M, N, O = p[J],
				...
				X = " noopener",
				Y = "_blank",
				Z = o && d[T] ? d[T].icon : V[1],
				$ = o && d[T] ? d[T].color : V[2] || "CAE0FF",
				_ = V[3] || {},
				aa = _.type,
				ba = V[4],
				ca = !1,
				...
				ea = "",
				fa = {};
			if (R ? (b.target = O, a2a.init(c, b, 1), T = "a2a", $ = "0166FF", Z = "a2a", da = !!S && 1) : "feed" == T || "print" == T ? (Y = "", X = "") : S && T && a2a.in_array(T, g) ? da = 1 : T && a2a.in_array(T, f) && (a2a.kit[T](), ca = 1), T && !ca) {
				if (R || (O.target = Y, !o || !d[T] && h(T, !0) ? "feed" == T ? O.href = O.href || a.linkurl : (O.href = "/#" + T, a2a.add_event(O, "mousedown", j), a2a.add_event(O, "keydown", j), O.rel = "nofollow" + X) : O.href = e(O, T), O.a2a = {}, O.a2a.customserviceuri = ba, O.a2a.stype = aa, O.a2a.linkurl = a.linkurl, O.a2a.servicename = W, O.a2a.safename = T, _.src && (O.a2a.js_src = _.src), _.url && (O.a2a.url = _.url), _.pu && (O.a2a.popup = 1), _.media && (O.a2a.media = 1), o || a2a.add_event(O, "click", function(a, b, d, e, f) {
						return function(g) {
							var h = screen.height,
								i = 550,
								j = 450,
					...
					for (var ga, ha = 0, ia = U.length; ha < ia; ha++)
						if (ga = U[ha].className, 1 == U[ha].nodeType && "a2a_label" != ga && (N = !0, "string" == typeof ga && ga.indexOf("a2a_count") >= 0)) {
							M = !0;
							break
						}
					if (!N) {
						K = document.createElement("span"), K.className = E + Z + " a2a_img_text", $ && (K.style.backgroundColor = "#" + $), L = a2a.svg.get(Z, K, A), "pending" !== L && (K.innerHTML = L);
						for (var ja in F) K.style[ja] = F[ja];
						O.insertBefore(K, U[0])
					}
				} else {
					K = document.createElement("span"), K.className = E + Z, $ && (K.style.backgroundColor = "#" + $), L = a2a.svg.get(Z, K, A), "pending" !== L && (K.innerHTML = L);
					for (var ja in F) K.style[ja] = F[ja];
	...
	miniLeaveDelay: function() {
		var a = a2a.type,
			...
			c = a2a.gEl,
			d = a2a.getStyle,
			e = d(c(b + "_dropdown"), "display");
		"none" != e && "none" == d(c(b + "_full"), "display") && (a2a[a].out_delay = setTimeout(function() {
	...
	toggle_dropdown: function(a, b) {
		if ("none" != a || !a2a[b].no_hide) {
			...
			d.style.display = a, e && "none" == a2a.getStyle(c("a2a" + b + "_full"), "display") && (e.style.display = a), a2a.miniEnterStay(), "none" == a ? (a2a.show_menu["doc_click_listener_" + b].destroy(), delete a2a[b].doc_click_close_mini, delete a2a[b].time_open, f && f[b] && f[b].destroy()) : a2a[b].onclick || a2a[b].time_open || (a2a[b].time_open = setTimeout(function() {
				a2a[b].time_open = "OK"
			}, 501))
		}
	},
	...
	svg: {
		...
		loadCSS: function(a) {
			var b = a2a.c.static_server,
				c = a2a.fix_icons,
				d = ["icons.23.svg.css", "icons.23.png.css", "icons.23.old.css"],
				e = a2a.svg.works(),
...
a2a.c = a2a_config, a2a.make_once = function(a) {
		if (a2a.type = a2a.c.menu_type || a, !a2a[a2a.type] && !window["a2a" + a2a.type + "_init"]) {
			a2a[a2a.type] = {}, window.a2a_show_dropdown = a2a.show_menu, window.a2a_miniLeaveDelay = a2a.miniLeaveDelay, window.a2a_init = a2a.init, a2a["create_" + a2a.type + "_dropdown"] = function(a, b) {
				...
				a2a.css(), w = i.localize = {
					...
					FindAnyServiceToAddTo: w.FindAnyServiceToAddTo || "Find any service",
					PoweredBy: w.PoweredBy || "By",
					AnyEmail: "Any email",
				...
				for (var D = 0, K = b.email, L = K.length; D < L; D++) {
					var J = K[D];
					I && a2a.in_array(J[1], I, !0) || f(h + "_2_col1").appendChild(C(J[0], J[1], J[2], J[3], J[4]))
				}
				if ("feed" != g) {
					var M = C("Email app", "email_app", "email", null, null, "mailto:?subject=A2A_LINKNAME_ENC&body=A2A_LINKURL_ENC");
					M.className = "a2a_i a2a_emailer a2a_email_client", M.id = "a2a" + g + "_email_client", M.target = "", f(h + "_2_col1").appendChild(M)
				}
				a2a[g].services = b.most.concat(b.email), "mail" != g && (a2a.add_event(f(h + "_overlay"), "click", function(a) {
					a2a.hide_full(g)
				}), a2a.add_event(f(h + "_show_more_less"), "click", function(a) {
			...
			b.page = {
				most: [
					...
					["Threema", "threema", "threema", "2A2A2A", {
						url: "threema://compose?text=${title}"
					}],
			...
			d.onclick = f.onclick || !1, d.show_title = f.show_title || !1, d.num_services = f.num_services || 8, d.exclude_services = f.exclude_services || !1, d.custom_services = f.custom_services || !1, a2a.locale = a2a.i18n(), a2a.locale && "custom" != a2a.locale ? (a2a.loadExtScript(f.static_server + "/locale/" + a2a.locale + ".js", function() {
				return "" != a2a_localize
			}, function() {
	...
	function() {
		document.body && (a2a.init_all("page"), a2a.ready()), a2a.dom.ready(function() {
			a2a.init_all("page"), a2a.ready()
		})
	}();